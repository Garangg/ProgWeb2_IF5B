...
@section('content')
    {{-- Heroes --}}
    {{-- <div class="container-fluid col-xxl-12 p-5 bg-dark mb-5" style="height: 750px">
    ...
    {{-- <div class="container my-4">
        <div class="pricing-header p-3 pb-md-4 mb-4 mx-auto text-center">
            <h1 class="display-4 fw-normal text-body-emphasis mb-5">Pricing</h1>
            <p class="fs-5 text-body-secondary mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit quisquam
                veritatis facere iure soluta obcaecati adipisci quis similique excepturi, cupiditate fugit ea ipsam ex
                debitis rem sapiente dolor natus magni?</p>
        </div>
        <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
            <div class="col">
                <div class="card custom-card flex-fill mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3">
                        <h4 class="my-0 fw-normal">Basic</h4>
                    </div>
                    <div class="card-body d-flex flex-column">
                        <h1 class="card-title pricing-card-title m-4">65.000 IDR<small
                                class="text-body-secondary fw-light">/mo</small>
                        </h1>
                        <ul class="list-unstyled my-5">
                            <li>Unlimited ad-free movies, series, and documentaries</li>
            ...
            <div class="col">
                <div class="card custom-card flex-fill mb-4 rounded-3 shadow-sm border-primary">
                    <div class="card-header py-3 text-bg-primary border-primary">
                        <h4 class="my-0 fw-normal">Standard</h4>
                    </div>
                    <div class="card-body d-flex flex-column">
                        <h1 class="card-title pricing-card-title m-4">120.000 IDR<small
                                class="text-body-secondary fw-light">/mo</small>
                        </h1>
                        <ul class="list-unstyled my-5">
                            <li>Unlimited ad-free movies, series, and documentaries</li>
            ...
            <div class="col">
                <div class="card custom-card flex-fill mb-4 rounded-3 shadow-sm ">
                    ...
                    <div class="card-body  d-flex flex-column">
                        <h1 class="card-title pricing-card-title m-4">186.000 IDR<small
                                class="text-body-secondary fw-light">/mo</small>
                        </h1>
                        <ul class="list-unstyled my-5">
                            <li>Unlimited ad-free movies, series, and documentaries</li>
    ...
    <div class="container">
        <div class="device-header p-3 pb-md-4 mb-2 mx-auto text-center">
            <h1 class="display-4 fw-normal text-body-emphasis my-5">Available in</h1>
            <p class="fs-5 text-body-secondary mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit quisquam
                veritatis facere iure soluta obcaecati adipisci quis similique excepturi, cupiditate fugit ea ipsam ex
                debitis rem sapiente dolor natus magni?</p>
        </div>
        <div class="mx-auto mb-5">
            <div class="row text-center">
                ...
                <div class="col-lg-4 my-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" fill="currentColor" class="bi bi-laptop mb-5" viewBox="0 0 16 16">
                        <path d="M13.5 3a.5.5 0 0 1 .5.5V11H2V3.5a.5.5 0 0 1 .5-.5h11zm-11-1A1.5 1.5 0 0 0 1 3.5V12h14V3.5A1.5 1.5 0 0 0 13.5 2h-11zM0 12.5h16a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5z"/>
                      </svg>
                    <h2 class="fw-normal mb-4">Windows or MacOS</h2>
                </div>
                <div class="col-lg-4 my-5">
