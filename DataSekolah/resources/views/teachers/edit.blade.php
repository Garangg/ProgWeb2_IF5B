...
<div class="container mx-auto px-4 flex items-center justify-center">
    <div class="mt-4 bg-white shadow-md w-50 rounded px-5 pt-6 pb-8 mb-4">
        ...
        <form action="{{ route('teachers.update', $teacher->id) }}" method="POST" class="mt-4 w-full">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                <label for="nip" class=" text-gray-700 text-sm font-bold mb-2">NIP</label>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="alamat" name="alamat" value="{{ $teacher->alamat }}"
                    class="shadow appearance-none border w-full rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    required>
            </div>
